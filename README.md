...
| MeshWX v5 wire format, spec revision 4 | shipped |
...
(revision 4) and [`docs/meshwx_v5_vectors.json`](docs/meshwx_v5_vectors.json).
...
- [`docs/MeshWX_v5_Spec.md`](docs/MeshWX_v5_Spec.md) — the protocol and the app developer's guide (wire, requests, bundle, rendering), revision 4. The current contract.
...
- [x] MeshWX v5 revision 4: GRP_DATA on `#meshwx`, warning/cancel/digest/observations/forecast/text/not available/coverage, `>` request grammar
